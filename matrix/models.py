...
class UserInvitation(models.Model):
    ...
    def emit_invitation(self):
        ...
        r = requests.post(f'https://{settings.MATRIX_HOMESERVER}/_matrix/client/r0/login', json=payload)
        access_token = r.json().get("access_token")
        if not access_token:
            return False
        r = requests.post(f'https://{settings.MATRIX_HOMESERVER}/_matrix/client/r0/rooms/{self.room.room_id}/invite',
